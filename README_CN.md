...
新版 FLIP-27 Source、FLIP-27 Sink 和 SQL Connector 的用法与参数已拆分到独立文档：

* [新版 Source / Sink / SQL Connector 使用说明](./FLIP27_SOURCE_SINK_CN.md)

旧 `FlinkLogConsumer` / `FlinkLogProducer` 属于老 DataStream 接口，后续会删除。老接口说明仍保留在本文档中，建议新作业优先使用独立文档中的新版接口。
